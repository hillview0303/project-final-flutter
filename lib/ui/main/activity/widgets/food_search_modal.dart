  ...
  static void show(BuildContext context, List<FoodDetail> foods, Color accentColor) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Padding(
          padding: MediaQuery.of(context).viewInsets,  // Adjust padding based on the keyboard visibility
              ...
              builder: (BuildContext context, ScrollController scrollController) {
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      TabBar(
                        labelColor: accentColor,  // Use the accent color passed to the function
